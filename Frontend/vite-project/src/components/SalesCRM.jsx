...
const SalesCRM = () => {
  ...
  const handleUpdateLead = async () => {
    try {
      await axios.put(
        `${LEAD_API}/update-lead/${selectedLead._id}`,
        extraForm,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
            ...
            <Dialog.Panel className="bg-white w-full max-w-xl rounded-xl p-6 shadow-xl">
              ...
              >
                ...
                <textarea
                  ...
                  className="input-style col-span-2 resize-none"
                  rows={3}
                />
                <button
                  type="submit"
            ...
            <Dialog.Panel className="bg-white w-full max-w-xl rounded-xl p-6 shadow-xl overflow-y-auto max-h-[90vh]">
              ...
              {selectedLead && (
                <div className="space-y-2 text-sm text-gray-800">
                  <p>
                    <strong>Lead No:</strong> {selectedLead.leadNo}
                  </p>
                  <p>
                    <strong>Lead Date:</strong>{" "}
                    {new Date(selectedLead.leadDate).toLocaleString()}
                  </p>
                  <p>
                    <strong>Name:</strong> {selectedLead.customerName}
                  </p>
                  <p>
                    <strong>Contact:</strong> {selectedLead.customerContact}
                  </p>
                  <p>
                    <strong>Email:</strong> {selectedLead.customerEmail}
                  </p>
                  <p>
                  ...
                  <p>
                    <strong>Service:</strong> {selectedLead.servicesRequired}
                  </p>
                  <p>
                    <strong>Due:</strong>{" "}
                    {new Date(selectedLead.dueDate).toLocaleDateString()}
                  </p>
                  <p>
                    <strong>Description:</strong> {selectedLead.description}
                  </p>
                  <p>
                    <strong>Actioned By:</strong> {selectedLead.actionedBy}
                  </p>
                  ...
                  <div className="grid gap-3 pt-4 border-t mt-4">
                    <label>
                      ...
                      >
                        ...
                        <option value="search engine/website">
                    ...
                    <label>
                      ...
                      <select
                        className="input-style"
                        value={extraForm.contactedViaCall}
                        onChange={(e) =>
                          setExtraForm({
                            ...extraForm,
                            contactedViaCall: e.target.value,
                          })
                        }
                      >
                    ...
                    <label>
                      ...
                      <select
                        className="input-style"
                        value={extraForm.quotationStatus}
                        onChange={(e) =>
                          setExtraForm({
                            ...extraForm,
                    ...
                    <button
                      ...
                      className="bg-indigo-600 text-white rounded-lg px-4 py-2 mt-3 hover:bg-indigo-700 transition"
                    >
                      Update Lead
                    </button>
                  </div>
