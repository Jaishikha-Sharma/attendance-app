  ...
  const renderLinksByRole = (role) => {
    switch (role) {
      case 'Admin':
        return (
          <>
            ...
            <a href="/manage-users" className="nav-link">Users</a>
      ...
      case 'HR':
        return (
          <>
            <a href="/hr-dashboard" className="nav-link">Dashboard</a>
      ...
      case 'Employee':
        return (
          <>
            <a href="/employee-dashboard" className="nav-link">Dashboard</a>
            <a href="/analytics" className="nav-link">Analytics</a>
            <a href="/profile" className="nav-link">Profile</a>
          </>
        );
      case 'Freelancer':
        return <a href="/freelancer-dashboard" className="nav-link">Dashboard</a>;
      case 'Project Coordinator':
        return (
          <>
            <a href="/coordinator-dashboard" className="nav-link">Dashboard</a>
  ...
  return (
    <header className="bg-white shadow-md border-b border-gray-200">
      <div className="container mx-auto flex items-center justify-between px-4 py-4 flex-wrap md:flex-nowrap">
        ...
        {/* Navigation Links */}
        <nav className={`w-full md:w-auto md:flex gap-5 items-center text-sm mt-4 md:mt-0 ${mobileOpen ? 'block' : 'hidden'} md:block`}>
